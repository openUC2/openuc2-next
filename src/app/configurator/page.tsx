  ...
  return (
    <>
      ...
      <Section>
        ...
        <ScrollReveal>
          <img src={`${basePath}/images/configurator.png`} alt="Screenshot of the configurator interface showing a drag-and-drop grid with cube modules and a beam path preview" className="rounded-lg border border-uc2-border" />
        </ScrollReveal>
      </Section>
