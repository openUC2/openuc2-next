    ...
    <div class="nav-inner">
      ...
      <ul class="nav-links">
        ...
        <li>
          ...
          <div class="dropdown-menu">
            <a href="${b}applications/index.html" style="font-weight:600;">All Applications →</a>
            <div class="dd-label" style="margin-top:8px">Imaging Modalities</div>
            <a href="${b}applications/fluorescence.html">Fluorescence Imaging</a>
            <a href="${b}applications/flim.html">FLIM &amp; Advanced Fluorescence</a>
            <div class="dd-label" style="margin-top:8px">Life Science Workflows</div>
            ...
            <a href="${b}applications/organoid.html">Organoid QC (In-Incubator)</a>
            <a href="${b}applications/multiwell.html">Multiwell Screening (96/384-well)</a>
  ...
  <footer class="site-footer">
    <div class="container">
      <div class="footer-grid">
        ...
        <div>
          <h4>Applications</h4>
          <a href="${b}applications/fluorescence.html">Fluorescence</a>
          <a href="${b}applications/histology.html">Histology</a>
          <a href="${b}applications/livecell.html">Live-Cell Imaging</a>
          <a href="${b}applications/multiwell.html">Multiwell Screening</a>
          <a href="${b}applications/index.html">All Applications →</a>
        </div>
        <div>
          <h4>Resources</h4>
